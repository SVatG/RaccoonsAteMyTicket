...
void effectLichthausRender(C3D_RenderTarget* targetLeft, C3D_RenderTarget* targetRight, float row, float iod) {
...
void effectLichthausExit() {
    freeFBXObject(&modelLichthaus);
